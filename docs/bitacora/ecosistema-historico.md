# Bitácora del ecosistema Zyntello — histórico

> Movida desde `CLAUDE.md` el 2026-09-08. **No se ha borrado ni una línea.**
>
> Cubre los tres repositorios (sitio web, admin y app). El detalle técnico de la app tiene
> además su propia bitácora en `app/zyntello-app/docs/bitacora/app-historico.md`.
