...
const APPS_FALLBACK = [
  { id: 'crm',          nombre: 'CRM',           subtitulo: 'Gestión de Clientes y Ventas',          descripcion: 'Administra tu pipeline de ventas, historial de clientes y oportunidades comerciales desde un solo lugar.', precio: 30,  precioAnual: 25, color: '#3b82f6', gradiente: 'linear-gradient(135deg, #1e3a8a 0%, #3b82f6 60%, #60a5fa 100%)', ahorroAnual: '2 MESES GRATIS', url: 'https://app.zyntello.com/demo/crm',          caracteristicas: ['Pipeline de ventas visual Kanban', 'Historial completo de interacciones', 'Gestión de contactos y empresas', 'Reportes y métricas de ventas', 'Integración con WhatsApp y email'] },
