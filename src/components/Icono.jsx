/**
 * Iconografía del sitio — SVG de trazo, nunca emojis.
 *
 * Un emoji lo dibuja el sistema operativo: cambia de forma entre Windows, iOS y
 * Android, no hereda el color de la marca y el lector de pantalla lo lee en voz
 * alta con su nombre oficial («cara de robot»), que no es lo que dice la tarjeta.
 * Un SVG de trazo hereda `currentColor`, mide siempre lo mismo y es decorativo
 * de verdad para quien navega con lector de pantalla.
 *
 * Uso:
 *   <Icono nombre="nube" size={24} />                → decorativo (aria-hidden)
 *   <Icono nombre="correo" titulo="Escríbenos" />    → con nombre accesible
 */
...
const TRAZOS = {
  ...
  robot: <><rect width="18" height="10" x="3" y="11" rx="2" /><circle cx="12" cy="5" r="2" /><path d="M12 7v4" /><path d="M8 16h.01" /><path d="M16 16h.01" /></>,
  ...
  salvavidas: <><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="4" /><path d="m4.93 4.93 4.24 4.24" /><path d="m14.83 9.17 4.24-4.24" /><path d="m14.83 14.83 4.24 4.24" /><path d="m9.17 14.83-4.24 4.24" /></>,
  ...
  servidor: <><rect width="20" height="8" x="2" y="2" rx="2" /><rect width="20" height="8" x="2" y="14" rx="2" /><path d="M6 6h.01" /><path d="M6 18h.01" /></>,
  ...
  subida: <><path d="M16 7h6v6" /><path d="m22 7-8.5 8.5-5-5L2 17" /></>,
