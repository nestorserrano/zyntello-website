...
> Último commit en **zyntello-app**: `[CXP-F0]` (FASE 0 CxP: contabilidad del pago — asiento por pago, sync Compras, dif cambiaria, anticipos, comprobante, guardas) | Último commit en **zyntello-admin**: `[#498]` `59f3ed8` | Último commit en **zyntello-website**: `735fcc0`
