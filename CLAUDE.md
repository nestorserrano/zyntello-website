...
> Último commit en **zyntello-app**: `[CXP-F4]` (FASE 4 CxP: reportes analíticos, conciliación de proveedor, dashboard con KPIs de fuente única y alertas — CIERRA el blueprint CxP F0–F4) | Último commit en **zyntello-admin**: `[#498]` `59f3ed8` | Último commit en **zyntello-website**: `735fcc0`
