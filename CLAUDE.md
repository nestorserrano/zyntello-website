...
> Último commit en **zyntello-app**: `[COM-F4-3]` `dede5793` (FASE 4 Compras: cycle time / PPV-ahorro-maverick / Proveedor 360 — CIERRA el blueprint de Compras F0–F4) | Último commit en **zyntello-admin**: `[#498]` `59f3ed8` | Último commit en **zyntello-website**: `735fcc0`
